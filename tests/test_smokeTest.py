...
class TestSmokeTest():
  ...
  def test_adminPage(self):
    ...
    self.driver.find_element(By.ID, "username").send_keys("onesies")
  ...
  def test_joinPage(self):
    ...
    assert len(elements) > 0
    self.driver.find_element(By.NAME, "fname").send_keys("Belén")
    self.driver.find_element(By.NAME, "lname").send_keys("Chaparro")
    self.driver.find_element(By.NAME, "bizname").send_keys("NameOfBusiness")
    self.driver.find_element(By.NAME, "biztitle").send_keys("Chief")
